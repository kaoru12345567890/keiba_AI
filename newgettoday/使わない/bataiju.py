...
def update_bataiju_all_races():
    # 1. 開催情報の入力
    raw_input_str = "2026020111"  # 例: 2026020111
    try:
        year = int(raw_input_str[0:4])
        kai = int(raw_input_str[6:8])
        nichime = int(raw_input_str[8:10])
    except (ValueError, IndexError):
        print("入力形式が正しくありません。")
        return
    
    # 保存先の定義
    output_filename = fr"C:\keiba_AI\newgettoday\hakodate_{year}02{kai:02d}{nichime:02d}.csv"
