...
for target_year in tqdm(years, desc="学習進捗"):
    ...
    # 【変更点】人気関連を排除し、実力指標のみで構成
    current_features = [
        '過去平均着順', '過去複勝率', '斤量', '馬体重', 
        'weight_ratio', 'weight_diff', 'weight_age_ratio',
        'course_key', 'track_condition', 
        'jockey_cond_rate', 'trainer_place_rate', 'jockey_trainer_rate'
    ]
