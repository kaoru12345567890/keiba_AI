...
le_cols = ['天気', '馬場状態', 'レース条件', '芝ダート', '回り', '騎手', '調教師名', '所属', '性別', '場所', 'course_key', 'track_condition']
...
for target_year in tqdm(years, desc="学習進捗"):
    ...
    current_features = [
        ...
        '馬体重', 'weight_ratio', 'weight_diff', 'course_key', 'track_condition',
