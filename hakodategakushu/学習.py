...
# ==========================================
# ★ pkl ファイル保存先の設定とフォルダ自動生成
# ==========================================
SAVE_DIR = r'C:\keiba_AI\final\models'
...
joblib.dump(stats_dict, os.path.join(SAVE_DIR, 'stats_dict.pkl'))
print("統計辞書を保存しました。")
...
for target_year in tqdm(years, desc="本番ローリング実行中"):
    ...
    joblib.dump(jockey_eff_dict, os.path.join(SAVE_DIR, 'jockey_efficiency_backtest.pkl'))
    ...
    # 騎手補正と最終デバフ
    loaded_jockey_eff = joblib.load(os.path.join(SAVE_DIR, 'jockey_efficiency_backtest.pkl'))
...
joblib.dump(final_jockey_eff_dict, os.path.join(SAVE_DIR, 'jockey_efficiency_final.pkl'))

# ==========================================
# 11. 各種オブジェクト・スケーラーの保存
# ==========================================
joblib.dump(final_m_rank, os.path.join(SAVE_DIR, 'model_rank.pkl'))
joblib.dump(final_m_class, os.path.join(SAVE_DIR, 'model_class.pkl'))
joblib.dump(final_m_reg, os.path.join(SAVE_DIR, 'model_reg.pkl'))
joblib.dump(final_feats, os.path.join(SAVE_DIR, 'feature_names.pkl')) 
